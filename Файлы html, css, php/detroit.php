...
// Запрашиваем информацию о Detroit   из базы данных
        ...
        if ($result) {
            ...
            if ($cyberpunk_info) {
                ...
                <div id="boxgame">
                    ...
                    <img src="uploads\12.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о Detroit не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о Detroit : ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
