...
// Запрашиваем информацию о Valheim  из базы данных
        ...
        if ($result) {
            ...
            if ($cyberpunk_info) {
                ...
                <div id="boxgame">
                    ...
                    <img src="uploads\15.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о Valheim не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о Valheim : ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
