...
<body>
    <div id="main_conteiner">
        ...
        if ($result) {
            ...
            // Проверяем, есть ли информация о GoW
            if ($cyberpunk_info) {
                ?>
                <div id="boxgame">
                    <h2><?= $cyberpunk_info['Название'] ?></h2>
                    <img src="uploads\8.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о GoW не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о GoW: ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
