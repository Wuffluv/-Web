...
<body>
    <div id="main_conteiner">
        ...
        if ($result) {
            ...
            // Проверяем, есть ли информация о Cyberpunk 2077
            if ($cyberpunk_info) {
                ?>
                <div id="boxgame">
                    <h2><?= $cyberpunk_info['Название'] ?></h2>
                    <img src="uploads\6.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о Cyberpunk 2077 не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о Cyberpunk 2077: ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
