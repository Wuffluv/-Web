...
// Запрашиваем информацию о Warframe из базы данных
        ...
        if ($result) {
            ...
            if ($cyberpunk_info) {
                ...
                <div id="boxgame">
                    ...
                    <img src="uploads\9.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о Warframe не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о Warframe: ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
