...
// Запрашиваем информацию о DS  из базы данных
        ...
        if ($result) {
            ...
            if ($cyberpunk_info) {
                ...
                <div id="boxgame">
                    ...
                    <img src="uploads\13.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о DS не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о DS: ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
