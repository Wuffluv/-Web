...
// Запрашиваем информацию о AS   из базы данных
        ...
        if ($result) {
            ...
            if ($cyberpunk_info) {
                ...
                <div id="boxgame">
                    ...
                    <img src="uploads\11.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о AS не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о AS : ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
