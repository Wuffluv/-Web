...
// Запрашиваем информацию о GT из базы данных
        ...
        if ($result) {
            ...
            if ($cyberpunk_info) {
                ...
                <div id="boxgame">
                    ...
                    <img src="uploads\7.png" alt="<?= $cyberpunk_info['Название'] ?>">
                    <table>
                        <tr>
                            <th>Разработчик</th>
                ...
                echo 'Информация о GT не найдена.';
            }
        } else {
            echo 'Ошибка при запросе информации о GT: ' . mysqli_error($connect);
        }
        ?>
    </div>            
</body>
